...
/**
  ...
  *@array: the array to search in. ppoints to first value
  *@low: the leftmost value of the search block
  *@high: the highest value in the search block
...
/**
  *exponential_search - perfoms an exponential
  *search in a sorted array of integers
